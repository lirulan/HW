...
// 客户模块管理
export const getCustListPage = params => {
    return axios.get(`${base}/api/cust/get`, {params: params});
};

export const removeCust = params => {
    return axios.delete(`${base}/api/cust/delete`, {params: params});
};
export const editCust = params => {
    return axios.put(`${base}/api/cust/put`, params);
};
export const addCust = params => {
    return axios.post(`${base}/api/cust/post`, params);
};
