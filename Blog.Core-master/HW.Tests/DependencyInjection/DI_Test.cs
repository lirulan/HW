...
namespace HW.Tests
{
    public class DI_Test
    {
        ...
        public IContainer DICollections()
        {
            ...
            var servicesDllFile = Path.Combine(basePath, "HW.Services.dll");
            ...
            var repositoryDllFile = Path.Combine(basePath, "HW.Repository.dll");
