...
using HW;
using HW.Common;
using HW.Common.Core;
using HW.Common.Helper;
using HW.Extensions;
using HW.Extensions.Apollo;
using HW.Extensions.Middlewares;
using HW.Extensions.ServiceExtensions;
using HW.Filter;
using HW.Hubs;
using HW.Serilog.Utility;
...
app.UseSwaggerMiddle(() => Assembly.GetExecutingAssembly().GetManifestResourceStream("HW.Api.index.html"));
